...
public:
	...
	*/
	 ...
	 */
	bool DrawImage(dui::common::dui_refptr<dui::render::IRenderContext> pRender, Image& duiImage, const std::wstring& strModify = L"", int nFade = DUI_NOSET_VALUE);

	/**
	* @brief 获取绘制上下文对象
	* @return 返回绘制上下文对象
	*/
	dui::common::dui_refptr<dui::render::IRenderContext> GetRenderContext();
	...
	*/
	 ...
	 * @return 待补充
	 */
	virtual void AlphaPaint(dui::common::dui_refptr<dui::render::IRenderContext> pRender, const UiRect& rcPaint);
	...
	* @return 无
	*/
	virtual void Paint(dui::common::dui_refptr<dui::render::IRenderContext> pRender, const UiRect& rcPaint);
	...
	* @return 无
	*/
	virtual void PaintChild(dui::common::dui_refptr<dui::render::IRenderContext> pRender, const UiRect& rcPaint) {};
...
protected:
	...
	virtual void PaintShadow(dui::common::dui_refptr<dui::render::IRenderContext> pRender);
	virtual void PaintBkColor(dui::common::dui_refptr<dui::render::IRenderContext> pRender);
	virtual void PaintBkImage(dui::common::dui_refptr<dui::render::IRenderContext> pRender);
	virtual void PaintStatusColor(dui::common::dui_refptr<dui::render::IRenderContext> pRender);
	virtual void PaintStatusImage(dui::common::dui_refptr<dui::render::IRenderContext> pRender);
	virtual void PaintText(dui::common::dui_refptr<dui::render::IRenderContext> pRender);
	virtual void PaintBorder(dui::common::dui_refptr<dui::render::IRenderContext> pRender);
	virtual void PaintLoading(dui::common::dui_refptr<dui::render::IRenderContext> pRender);
